...
import com.mikepenz.aboutlibraries.util.Util.getPackageInfo
...
class MainActivity : BaseActivity(), ListFragment.TabHost {
    ...
    private fun showCreateOptions() {
        MenuDialogBuilder(context)
                ...
                .item(R.string.button_external_app_import, this::openExternalApp)
                .showIfPossible()
    }


    private fun doSetUpPagerView(){
        setupViewPager()
    ...
    private fun openExternalApp() {
        var i = Intent(this, ChooserActivity::class.java)
...
//        }
    ...
    public override fun onActivityResult(requestCode: Int, resultCode: Int, intent: Intent?) {
        ...
        Log.d("TAG!", "OnResult in MAINNNNNNN")
